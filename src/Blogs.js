...
const Blogs=()=>{
  const [blogs, setBlogs] =useState ([
    ...
    {title:"Day 5:It's Coming Together",body:"I wrote the code and my blog was now coming out according to my design in spite their being some issues in styling the blog.", date:"14/4/2022",id:5, src:"https://www.howtopython.org/wp-content/uploads/2020/04/laptops_python.jpg "},
    {title:"Day 6:Completed Blog",body:"At last my blog is completed with all the features I had wanted to implement.My React journey had been a little challenging but all in all I managed to learn the basics and keep on learning to increase my knowledge. ",date:"20/5/2022",id:6,src:"https://creativetimblog.com/blog/wp-content/uploads/2020/07/react-projects-730x410.jpg"} 
  ]) 

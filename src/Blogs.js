...
const Blogs=()=>{
  const [blogs, setBlogs] =useState ([
    ...
    {title:"Day 6:Completed Blog.",body:"At last my blog is completed with all the features I had wanted to implement.",date:"20/5/2022",id:6,src:"https://creativetimblog.com/blog/wp-content/uploads/2020/07/react-projects-730x410.jpg"} 
  ]) 
